...
import com.zhang.nong.doctor.adapters.Home_Nearby_Pro_Adapter;
...
public class Home_professor_Activity extends AppCompatActivity {
    ...
    TextView zhuanjia_advisory;//咨询专家
    List<Expert> mProfessorList;//获取专家的表
    Expert mProfessor1, mProfessor2, mProfessor3;//模拟数据，添加3个专家
    Home_Nearby_Pro_Adapter mNearby_pro_adapter;//专家的适配器
    ...
    private void initDatas() {
        ...
        //设置适配器
        mNearby_pro_adapter = new Home_Nearby_Pro_Adapter
                (Home_professor_Activity.this, R.layout.home_nearby_professor_item, mProfessorList, 1);
    ...
    private void initEvent() {
        ...
        zhuanjia_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳转到首页界面
                onBackPressed();
                Home_professor_Activity.this.finish();
            }
        });
    /*//对listview中的咨询项目监听
