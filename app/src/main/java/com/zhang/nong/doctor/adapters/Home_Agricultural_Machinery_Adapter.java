 ...
 */
public class Home_Agricultural_Machinery_Adapter extends BaseAdapter {
 Context mContext;
private List<Machine> mMachineList;
private LayoutInflater mInflater;

public Home_Agricultural_Machinery_Adapter(Context context, List<Machine> machineList) {
