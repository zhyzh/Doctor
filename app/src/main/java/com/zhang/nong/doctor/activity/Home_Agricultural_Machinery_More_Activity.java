...
import com.zhang.nong.doctor.adapters.Home_Agricultural_Machinery_Adapter;
import com.zhang.nong.doctor.com.java.beans.Machine;

import java.util.ArrayList;
import java.util.List;

public class Home_Agricultural_Machinery_More_Activity extends AppCompatActivity {
    List<Machine> mMachineList;
    Machine mMachine1, mMachine2, mMachine3;
    Home_Agricultural_Machinery_Adapter mMachinery_Adapter;
    ...
    private void initViews() {
        //获取listview
        mListView = (ListView) findViewById(R.id.lv_agricultural_machinery_more_list);
        iv_agricultural_machinery_more_back = (ImageView) findViewById
                (R.id.iv_agricultural_machinery_more_back);
        //
    ...
    private void initDatas() {
        ...
        //设置适配器
        mMachinery_Adapter = new Home_Agricultural_Machinery_Adapter
                (Home_Agricultural_Machinery_More_Activity.this, mMachineList);
    ...
    private void initEvent() {
        ...
        mSpinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>
                        (Home_Agricultural_Machinery_More_Activity.this, android.R.layout.simple_spinner_item,
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //定义意图
                Intent intent = new Intent(Home_Agricultural_Machinery_More_Activity.this,
                        Home_Agricultural_Machinery_Detail_Info_Activity.class);
                //传值
